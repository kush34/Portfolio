  ...
  return (
    <div className=' h-1/3 md:flex items-center text-zinc-300 rounded-xl'>
      ...
      <div className='md:w-2/3 flex flex-col  justify-center mx-5'>
        ...
        <div className="hover:text-zinc-400 hover:scale-101 duration-120 ease-in flex text-2xl justify-end mx-5 my-2 project-link">
          <a target='blank' href={`${props?.gitlink}`}><MdArrowOutward /></a> 
        </div>
      </div>
    </div>
  )
